...
|---|---|---|
| **Source** (权益账户) | name, category, currency, icon, website, phone, validFrom/validUntil, isArchived, cost, costCycle | Credit cards, insurance, memberships. Archive excludes from calculations. cost/costCycle track maintenance fees (e.g., annual fee). |
